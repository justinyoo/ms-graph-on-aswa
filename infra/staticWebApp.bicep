...
resource sttapp 'Microsoft.Web/staticSites@2022-03-01' = {
  ...
  tags: {
    'hidden-link: /app-insights-resource-id': staticApp.appInsights.id
    'hidden-link: /app-insights-instrumentation-key': staticApp.appInsights.instrumentationKey
    'hidden-link: /app-insights-conn-string': staticApp.appInsights.connectionString
  }
  properties: {
